...
public class CardAlojamiento extends AnchorPane implements Initializable {
    ...
    /**
     * Coloca el enlace del mapa en la posicion correcta y le a�ade un listener para abrirlo al pulsar
     */
	public void setMapa() {
	...
	/**
	 * A�ade la informacion de las habitaciones
	 */
	...
	/**
	 * A�ade la informacion de las estancias
	 */
