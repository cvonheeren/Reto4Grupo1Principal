...
INSERT INTO CLIENTES VALUES (NULL, '83178234E', MD5('1234'), 'NURIA', 'RUIZ RAMOS', '1984-02-24', CURRENT_DATE, 'nuria.ruiz@gmail.com');
INSERT INTO CLIENTES VALUES (NULL, '01820557S', MD5('1234'), 'ALBERTO', 'ASENSIO GARCIA', '1976-05-01', CURRENT_DATE, 'alberto.asensio@gmail.com');
INSERT INTO CLIENTES VALUES (NULL, '12345678A', MD5('1234'), 'PRUEBAS', 'AAAAA', '1976-05-01', CURRENT_DATE, 'testeo@gmail.com');

-- TABLA HABITACIONES --

INSERT INTO HABITACIONES VALUES (NULL, 'HABITACION DOBLE ESTANDAR', @DESC, 2, 0, 0, 15, 25, 30, 25.8);
INSERT INTO HABITACIONES VALUES (NULL, 'HABITACION DOBL
E MATRIMONIO', @DESC, 0, 1, 0, 15, 25, 30, 30);
...
INSERT INTO PROMOCIONES VALUES ((SELECT MD5(cast((rand() * 999999999999999) AS INT)) from dual),'12345678A',0.1);